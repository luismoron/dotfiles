...
SINGLE_MONITOR_SCRIPT="$HOME/$USER/Plantillas/dotfiles/screenlayout/single-monitor.sh"
DUAL_MONITOR_SCRIPT="$HOME/$USER/Plantilla/dotfiles/screenlayout/dual-monitor.sh"
